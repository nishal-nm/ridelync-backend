...
def get_user_reviews(request, user_id):
    try:
        ...
        for rating in driver_ratings:
            ...
            review_data = {
                ...
                "reviewer": {
                    ...
                    "profile_picture": (
                        reviewer.profile_picture.url
                        if hasattr(reviewer, "profile_picture")
                        and reviewer.profile_picture
                        else None
                    ),
                },
                "ride_details": {
        ...
        return Response({"count": len(reviews), "reviews": reviews})
